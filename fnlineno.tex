...
\title{\textsf{fnlineno.sty}\\---\\Numbering Footnote Lines\thanks{This
       ...
       describes version
       \textcolor{blue}{v0.55}
       of \textsf{fnlineno.sty} as of 2011/01/07.}}
% \listfiles                                          %% 2010/12/22
%% KW: 2026/03/08 - no longer building on modern TeX
...
%% |\begin{MDabstract}| of \LaTeX's \verb|{abstract}| environment:
  \newenvironment{MDabstract}
                 ...
                 {\@ifundefined{MDkeywordsstring}%
                  ...
                  \endabstract}
%% |\[MD]docnewline| 2012/11/12 from \verb|readprov.tex|:
  \newcommand*{\MDdocnewline}{\leavevmode\@normalcr[\topsep]}
%% <- \verb|\leavevmode| for use with \verb|\paragraph|.
...
%% |\qtdcode{<text>}|: 2012/10/24:
    \newcommand*{\qtdcode}[1]{\verb|\code{#1}|}
...
%% \verb|\MDsampleinput[{<file>}| was added 2012/11/06.
...
%% of \verb|\topsep| in the file \verb|myfilist.tex| (2012/11/30).
        \ifx\\#1\\\else
...
%         \nobreak\vskip\medskipamount
        \hrule \vskip-\parskip
        \bigskip %%% \bigbreak
%% \verb|\bigbreak| made much larger space in \verb|myfilist.tex|.
    \endgroup
}
%% |\ctanpkgdref{<pkg-id>}| adds the printed link to
%% \verb|ctan.org/pkg| as a footnote. There is a little space
...
such that even
\verb|\footnote|                                 %% `\' 2010/12/09
lines are numbered and can be referred to
using \verb|\linelabel|, \verb|\ref|, etc.
%% rm. 2011/02/09:
...
For this purpose, an extension 'edfnotes' of the \verb|ednotes|
...
\verb|inner| material such as table cells.
%% <- 2011/02/14 ->
% \dots
